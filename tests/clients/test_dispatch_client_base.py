...
from discord_bot.core.clients.dispatch_client_base import DispatchClientBase, RESULT_QUEUE_MAX_SIZE
...
def test_deliver_drops_and_logs_when_full(mocker):
    ...
    mock_logger = mocker.patch('discord_bot.core.clients.dispatch_client_base.logger')
    client = _ConcreteClient()
