...
from discord_bot.seams.broker.utils.integrations.s3 import list_objects, ObjectStorageException
...
def test_list_objects_empty(mocker):
    ...
    mocker.patch('discord_bot.seams.broker.utils.integrations.s3.client', return_value=mock_s3)
