...
def test_upload_file_success(mock_s3_client, tmp_path):
...
def test_upload_file_missing_path(mock_s3_client):
...
def test_upload_file_failure(mock_s3_client, tmp_path):
    file_path = tmp_path / "test.txt"
...
def test_delete_file_failure(mock_s3_client):
    # Simulate a boto3 error
