...
from discord_bot.utils.instrument import MusicSourceDictNaming, MusicSourceDownloadNaming
...
def source_download_attributes(source_download: SourceDownload) -> dict:
    ...
    '''
    return {
            MusicSourceDictNaming.UUID.value: source_download.source_dict.uuid,
