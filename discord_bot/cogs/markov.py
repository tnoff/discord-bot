...
from discord_bot.utils.instrument import otel_span_wrapper, command_wrapper, HeartbeatMetricNaming
...
HEARTBEAT_GAUGE = METER_PROVIDER.create_gauge(HeartbeatMetricNaming.MARKOV.value, unit='number', description='Markov heartbeat')
