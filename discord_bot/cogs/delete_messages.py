...
from discord_bot.utils.instrument import otel_span_wrapper, HeartbeatMetricNaming
...
HEARTBEAT_GAUGE = METER_PROVIDER.create_gauge(HeartbeatMetricNaming.DELETE_MESSAGES.value, unit='number', description='Delete messages heartbeat')
