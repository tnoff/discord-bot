...
class HeartbeatMetricNaming(Enum):
    '''
    Heartbeat Metrics
    '''
    DELETE_MESSAGES = 'delete_messages.heartbeat'
    MARKOV = 'markov.heartbeat'
    MUSIC_SEND_MESSAGES = 'music.send_messages.heartbeat'
    MUSIC_CLEANUP_PLAYERS = 'music.cleanup_players.heartbeat'
    MUSIC_CACHE_CLEANUP = 'music.cache_cleanup.heartbeat'
    MUSIC_DOWNLOAD_FILES = 'music.download_files.heartbeat'
    MUSIC_PLAYLIST_HISTORY = 'music.playlist_history.heartbeat'
