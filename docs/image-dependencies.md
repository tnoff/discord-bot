...
|---|---|---|
| `discord-bot` | 131 | 29 |
| `discord-dispatcher` | 66 | 10 |
| `discord-broker` | 98 | 16 |
| `discord-downloader` | 92 | 15 |
| `discord-search` | 103 | 20 |
| `discord-db` | 71 | 22 |
...
114 of 226 modules (50%) are imported by two or more entrypoints but not all 6. Splitting the tree into one
