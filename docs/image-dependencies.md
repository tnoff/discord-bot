...
| `discord-broker` | 72 | 10 |
| `discord-downloader` | 66 | 8 |
| `discord-search` | 71 | 12 |
| `discord-db` | 52 | 14 |
...
78 of 154 modules (50%) are imported by two or more entrypoints but not all 6. Splitting the tree into one
