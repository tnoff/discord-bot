...
|---|---|---|
| `discord-bot` | 98 | 27 |
| `discord-dispatcher` | 49 | 5 |
| `discord-broker` | 74 | 10 |
| `discord-downloader` | 67 | 8 |
| `discord-search` | 73 | 12 |
| `discord-db` | 53 | 14 |
...
82 of 158 modules (51%) are imported by two or more entrypoints but not all 6. Splitting the tree into one
