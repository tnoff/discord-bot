...
|---|---|---|
| `discord-bot` | 143 | 36 |
| `discord-dispatcher` | 70 | 10 |
| `discord-broker` | 103 | 16 |
| `discord-downloader` | 89 | 15 |
| `discord-search` | 100 | 20 |
| `discord-db` | 66 | 22 |
...
120 of 239 modules (50%) are imported by two or more entrypoints but not all 6. Splitting the tree into one
