...
|---|---|---|
| `discord-bot` | 131 | 27 |
| `discord-dispatcher` | 66 | 11 |
| `discord-broker` | 92 | 10 |
| `discord-downloader` | 84 | 8 |
...
115 of 198 modules (58%) are imported by two or more entrypoints but not all 6. Splitting the tree into one
